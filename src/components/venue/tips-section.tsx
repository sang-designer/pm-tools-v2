          ...
          <div className="relative z-10 flex flex-wrap items-center gap-2">
            ...
            <div className="relative" ref={reportRef}>
              ...
              {reportOpen && !flagged && (
                <ul
                  role="menu"
                  className="absolute right-0 z-50 mt-1 min-w-[10rem] rounded-md border border-border bg-popover p-1 text-popover-foreground shadow-md"
                >
          ...
          <div className="mt-3 space-y-3">
            {visible.map((tip) => (
              <TipCard
                ...
                reportOpen={reportOpenId === tip.id}
                onToggleReport={() =>
                  setReportOpenId((current) => (current === tip.id ? null : tip.id))
                }
                onCloseReport={() => setReportOpenId(null)}
                onFlag={(reason) => {
